...
def generate_test_case_file(msg_proto_file, msg_list_group, output_dir, base_idx, gap, pkg_name, namespace_list):
...
def test_001():
    ...
    if generate_test_case_file(msg_proto_file, msg_list_group, './output/demo', None, None, 'com::moon::demo::proto',
                               ['tcp', 'http', 'udp']) != 0:
        return -1
